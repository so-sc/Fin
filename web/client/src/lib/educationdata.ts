const commonFinance = [

    {
      ...
      "example": "Imagine a group of friends who each contribute money to buy a variety of snacks. They all share the snacks based on their contribution, and the group benefits from the variety."
    },
    {
        "title": "Stock/Share",
        "definition": "A stock (or share) represents ownership in a company. When you buy a stock, you own a small part of that company.",
        "example": "If you buy a share of a pizza company, you own a small portion of that company. If the company does well, your share becomes more valuable."
    },
    {
        ...
        "example": "Think of an ETF as a basket containing various types of fruit. Investors can buy and sell shares (or pieces) of this basket on the market, just like stocks.",
    },
    {
        "title": "DifferenceBetweenMutualFund",
        "definition": "Mutual Fund: Typically bought or sold through the fund company at the end of the trading day at the net asset value (NAV). ETF: Traded on stock exchanges throughout the day at market prices, similar to individual stocks.",
        "example": " ",
    },
    {
        "title": "Diversification in Finance",
        ...
        "example": "Instead of putting all your money into one type of fruit, like apples, you spread it across different fruits. If apples have a bad season, you still have other fruits."
    },
    {
        ...
        "example": "Investing in a high-risk, high-return stock is like buying a lottery ticket – you might win big, but there's a chance you could lose."
    },
    {
        "title": "Bond in Finance",
        ...
        "example": "Buying a bond is like lending money to a friend who promises to pay you back with interest after a certain period."
    }
  ...
  const FinancialIndicators = [
    ...
    {
      "title": "Financial Health and Debt Levels",
    ...
    {
      "title": "Market Share and Competitive Position",
    ...
    {
      "title": "Industry and Economic Trends",
  ...
  const MarketConcepts = [
    {
      ...
      "first": "This represents the willingness of buyers to purchase a stock at different prices. Factors influencing demand include investors' expectations, economic conditions, and company performance.",
      "second": "This represents the willingness of sellers to sell a stock at different prices. Shareholders may decide to sell for various reasons, such as profit-taking or changing investment goals."
    },
    {
...
const MarketConcepts2 = [
    {
      ...
      "description": "When a buyer's bid matches a seller's ask, a transaction occurs, and the stock is traded at the agreed-upon price."
    },
    {
      "title": "Continuous Adjustment",
      "description": "Prices are constantly adjusting based on new information, market sentiment, and changes in supply and demand. Stock prices can change rapidly during market hours."
    },
    {
        "title": "Market Orders and Limit Orders",
        "description": "A request to buy or sell a stock at the current market price. It is executed immediately. While an order to buy or sell a stock at a specified price or better. It will be executed only if the market reaches the specified price.",
    },
    {
        "title": "News and Information",
        "description": "News, economic reports, and company announcements can influence investor sentiment and impact supply and demand, leading to price changes."
        },
        {
        "title": "Market Exchanges",
        "description": "Stocks are traded on stock exchanges (e.g., NYSE, NASDAQ), where buyers and sellers come together. The exchange acts as a marketplace, providing a platform for trading."
        },
        {
        "title": "Technical Analysis and Chart Patterns",
        "description": "Some traders use technical analysis to predict future price movements based on historical price patterns, trends, and trading volumes."
        }
];
