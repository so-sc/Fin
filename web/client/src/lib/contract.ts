export function financialContract(
  receiverName: string,
  date: string,
  amount: string,
  companyName: string
  ...
  return `
    ...
    ${companyName}, a corporation organized and existing 
    under the laws of the , and ${receiverName},
    ...
    Company shall pay to Consultant Rs. ${amount} . In addition, the Company shall reimburse 
